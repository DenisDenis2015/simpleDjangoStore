...
urlpatterns = [
    ...
    path('product/<str:product_slug>/cart/<int:id>', views.AddProductToCart, name='AddProductToCart'), # TODO выпилить отсюда с вьюхи и тестов deprecated переделал на вызов ajax
